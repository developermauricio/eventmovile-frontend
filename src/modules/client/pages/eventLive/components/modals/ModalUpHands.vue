...
export default defineComponent({
    ...
    setup() {
        ...
        const getQuestionsForActivity = async () => {
            const responseHand = await getSendRequest(`questionsForActivity/${activity.value.id}/${user.value.id}`) 
        ...
        const sendQuestion = async () => {
            ...
            const responseQuestion = await postSendRequest('questionActivities', params)
            ...
            if ( responseQuestion ) {
                ...
                let params_2 = {
                    ...
                    answer: null,
                    id: responseQuestion.data.id,
                    type: 'text'
                }

                const topic = 'eventmovil/'+activity.value.event_id+'/'+activity.value.id+'/question';
                await publishMQTT(topic, JSON.stringify(params_2))
            }
