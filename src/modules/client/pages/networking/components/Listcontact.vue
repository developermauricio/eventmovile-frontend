          ...
          <ul class="ps-0 chat-user-list">
            ...
            <li class="p-3">
              <a class="d-flex" href="#">
                ...
                <!-- Info -->
                <div class="chat-user-info" data-bs-toggle="offcanvas" data-bs-target="#offcanvasBottomProfileNetworking"
                     aria-controls="offcanvasBottomProfileNetworking">
                  <h6 class="text-truncate mb-0">Albert Flores</h6>
                  <div class="last-chat">
                    <p class="mb-0 text-truncate">Starbucks</p>
                  </div>
                </div>
              </a>
              <!-- Options -->
              <div class="dropstart chat-options-btn">
                <button class="btn dropdown-toggle" type="button">
                  <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" class="bi bi-chat-left-text" viewBox="0 0 16 16">
            ...
            <li class="p-3 chat-unread">
              <a class="d-flex" href="page-chat.html">
                ...
                <div class="chat-user-thumbnail me-3 shadow">
                  <img class="img-circle" src="/assets/img/avatars/perfil-women.jpg" alt="">
                </div>
                <!-- Info -->
                <div class="chat-user-info">
                  <h6 class="text-truncate mb-0">Courtney Henry</h6>
                  <div class="last-chat">
                    <p class="mb-0 text-truncate">Johnson y Johnson</p>
                  </div>
                </div>
              </a>
              <!-- Options -->
