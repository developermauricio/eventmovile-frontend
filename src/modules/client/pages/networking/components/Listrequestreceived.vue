      ...
      <div class="card w-100">
        <div class="card-body">
          <ul class="ps-0 chat-user-list">
            <!-- Single Chat User -->
            <li class="p-2 chat-unread">
              <a class="d-flex" href="#">
                <!-- Thumbnail -->
                <div class="chat-user-thumbnail me-3 shadow" data-bs-toggle="offcanvas" data-bs-target="#offcanvasBottomProfileNetworking"
...
<!--                  <li><a href="#"><i class="bi bi-slash-circle"></i>Ban</a></li>-->
                  <li><a href="#"><i class="bi bi-trash"></i>Rechazar</a></li>
                </ul>
              </div>
            </li>
          </ul>
